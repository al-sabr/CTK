...
#! \endcode
#!
function(ctkFunctionCreateBlueBerryApplication)
...
if(NOT CMAKE_CURRENT_SOURCE_DIR MATCHES "^${CMAKE_SOURCE_DIR}.*")
  foreach(CTK_EXTENSION_DIR ${CTK_EXTENSION_DIRS})
    if(CMAKE_CURRENT_SOURCE_DIR MATCHES "^${CTK_EXTENSION_DIR}.*")
      get_filename_component(CTK_EXTENSION_ROOT_FOLDER ${CTK_EXTENSION_DIR} NAME)
      set_property(TARGET ${_APP_NAME} PROPERTY FOLDER "${CTK_EXTENSION_ROOT_FOLDER}/Applications")
      break()
    endif()
  endforeach()
else()
...
if(NOT _APP_NO_PROVISIONING)
  ...
  ctkFunctionCreateProvisioningFile(FILE ${_prov_file}
...
if(NOT _APP_NO_INSTALL)
  ...
  ctkFunctionInstallThirdPartyCTKPlugins(${_APP_PLUGINS} EXCLUDE ${_APP_EXCLUDE_PLUGINS})
  ...
  CTK_INSTALL_TARGETS(EXECUTABLES ${_APP_NAME} LIBRARY_DIRS ${_APP_LIBRARY_DIRS} GLOB_PLUGINS )

  if(NOT _APP_NO_PROVISIONING)
    # Install the provisioning file
    ctkFunctionInstallProvisioningFiles(${_prov_file})
  endif()

  # On Linux, create a shell script to start a relocatable application
  if(UNIX AND NOT APPLE)
    install(PROGRAMS "${CTK_SOURCE_DIR}/CMake/RunInstalledApp.sh" DESTINATION "." RENAME ${_APP_NAME}.sh)
  endif()
...
function(FunctionCreateBlueBerryApplication)
  message(SEND_ERROR "The function FunctionCreateBlueBerryApplication was renamed to ctkFunctionCreateBlueBerryApplication in MITK 2015.05")
endfunction()
