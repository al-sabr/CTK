...
macro(ctkMacroBuildPlugin)
  CtkMacroParseArguments(MY
    "EXPORT_DIRECTIVE;SRCS;MOC_SRCS;MOC_OPTIONS;UI_FORMS;INCLUDE_DIRECTORIES;EXPORTED_INCLUDE_SUFFIXES;TARGET_LIBRARIES;RESOURCES;CACHED_RESOURCEFILES;BYPASS_REGEX;
  ...
  if(NOT DEFINED MY_BYPASS_REGEX)
    set(MY_EXPORT_HEADER_PREFIX "${lib_name}_")
  else()
    set(MY_EXPORT_HEADER_PREFIX "${lib_name}")
    string(REGEX REPLACE "\\_" "" MY_EXPORT_HEADER_PREFIX ${MY_EXPORT_HEADER_PREFIX})
  endif()
