 ...
 */
template <typename T>
class ITK_EXPORT MemberCommand : public Command
{
public:
 ...
 */
template <typename T>
class ITK_EXPORT ReceptorMemberCommand : public Command
{
public:
 ...
 */
template <typename T>
class ITK_EXPORT SimpleMemberCommand : public Command
{
public:
 ...
 */
template <typename T>
class ITK_EXPORT SimpleConstMemberCommand : public Command
{
public:
...
class ITK_EXPORT CStyleCommand : public Command
{
public:
...
class ITK_EXPORT FunctionCommand : public Command
{
public:
  /** Standard class type aliases. */
