 ...
 * \ingroup ITKCommon
 */
class ITK_EXPORT MemoryAllocationError : public ExceptionObject
{
public:
 ...
 * \ingroup ITKCommon
 */
class ITK_EXPORT RangeError : public ExceptionObject
{
public:
  /** Default constructor.  Needed to ensure the exception object can be
   * copied. */
 ...
 * \ingroup ITKCommon
 */
class ITK_EXPORT InvalidArgumentError : public ExceptionObject
{
public:
  /**
   * Default constructor.  Needed to ensure the exception object can be
 ...
 * \ingroup ITKCommon
 */
class ITK_EXPORT IncompatibleOperandsError : public ExceptionObject
{
public:
  /** Default constructor.  Needed to ensure the exception object can be
   * copied. */
 ...
 * \ingroup ITKCommon
 */
class ITK_EXPORT ProcessAborted : public ExceptionObject
{
public:
  /** Default constructor.  Needed to ensure the exception object can be
   * copied. */
