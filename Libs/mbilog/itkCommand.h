...
class MBILOG_EXPORT Command : public Object
{
public:
 ...
 */
template <typename T>
class MBILOG_EXPORT MemberCommand : public Command
{
public:
 ...
 */
template <typename T>
class MBILOG_EXPORT ReceptorMemberCommand : public Command
{
public:
 ...
 */
template <typename T>
class MBILOG_EXPORT SimpleMemberCommand : public Command
{
public:
 ...
 */
template <typename T>
class MBILOG_EXPORT SimpleConstMemberCommand : public Command
{
public:
...
class MBILOG_EXPORT CStyleCommand : public Command
{
public:
...
class MBILOG_EXPORT FunctionCommand : public Command
{
public:
  /** Standard class type aliases. */
