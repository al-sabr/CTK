 ...
 * \ingroup ITKCommon
 */
class MBILOG_EXPORT ExceptionObject : public std::exception
{
public:
 ...
 * \ingroup ITKCommon
 */
class MBILOG_EXPORT MemoryAllocationError : public ExceptionObject
{
public:
 ...
 * \ingroup ITKCommon
 */
class MBILOG_EXPORT RangeError : public ExceptionObject
{
public:
  /** Default constructor.  Needed to ensure the exception object can be
   * copied. */
 ...
 * \ingroup ITKCommon
 */
class MBILOG_EXPORT InvalidArgumentError : public ExceptionObject
{
public:
  /**
   * Default constructor.  Needed to ensure the exception object can be
 ...
 * \ingroup ITKCommon
 */
class MBILOG_EXPORT IncompatibleOperandsError : public ExceptionObject
{
public:
  /** Default constructor.  Needed to ensure the exception object can be
   * copied. */
 ...
 * \ingroup ITKCommon
 */
class MBILOG_EXPORT ProcessAborted : public ExceptionObject
{
public:
  /** Default constructor.  Needed to ensure the exception object can be
   * copied. */
